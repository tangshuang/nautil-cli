...
const { exists, remove, readJSON, writeJSON, write, mkdir, copy, remove } = require('../../utils/file')
...
module.exports = function build(source) {
  ...
  plugins.push(new AfterHookPlugin(() => {
    ...
    copy(require.resolve('nautil/miniprogram_dist/wechat/components/dynamic'), path.resolve(distDir, 'components/dynamic'))
  }))
