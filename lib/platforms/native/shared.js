...
module.exports = function(source, dev) {
  ...
  const cssToObjectLoader = path.resolve(__dirname, '../../loaders/css-to-object-loader.js')
  const loaders = [
    jsxLoaders,
    {
      test: /\.css$/,
      use: [
        {
          loader: cssToObjectLoader,
        },
        ...createStylesheetLoaders({ css: false }),
      ],
    },
    {
      test: /\.less$/,
      use: [
        ...
        ...createStylesheetLoaders({ css: false, less: true }),
      ],
    },
    {
      test: /\.(sass|scss)$/,
      use: [
        ...
        ...createStylesheetLoaders({ css: false, sass: true }),
      ],
    },
    fileLoaders,
  ]
