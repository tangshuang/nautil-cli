...
module.exports = function build() {
  ...
  const MiniCssExtractPlugin = decideby(() => {
    if (exists(require.resolve('mini-css-extract-plugin'))) {
      console.log('hint--->')
      return require('mini-css-extract-plugin')
    }
    console.log('hint!!!!!')
    return require(path.resolve(cwd, 'node_modules/mini-css-extract-plugin'))
  })
  ...
  const OptimizeCSSAssetsPlugin = exists(require.resolve('optimize-css-assets-webpack-plugin')) ? require('optimize-css-assets-webpack-plugin') : require(path.resolve(cwd, 'node_modules/optimize-css-assets-webpack-plugin'))
